...
public class ArrayListPrintTime {
    public void printArrayList(ArrayListProcessor arrayListProcessor, ArrayList<Integer> list) {
        ...
        System.out.println("Time of getting an item from the middle of collection containing " + list.size() + " elements:" + arrayListProcessor.timeOfGetFromMiddleOfArrayList(list) + " [ms]");
