...
public class LettersArrayDeque {
    public void createArrayDequeWithLetters() {
        ...
        for (Letters d : letters) {
            System.out.println("[" + d.getNumber() + "] " + d.getLetter() + " (numbers of A letter: " + d.getLetter().length()+ ")");
        }

        System.out.println("Size of collection letters = " + letters.size() + " items.");

        ArrayListOfLetters arrayListOfLetters = new ArrayListOfLetters();
        arrayListOfLetters.filterLetters(letters);
    }
}
